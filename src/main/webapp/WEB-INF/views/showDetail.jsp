        ...
        <div class="row my-5 py-5">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-7">
                    ...
                    <form id="adoptionForm" action="<%= request.getContextPath() %>/adopt/<%= chat.getId() %>"
                        method="post">
                        <button type="button" onclick="submitAdoptionForm()" class="btn btn-primary">Adopt Now</button>
                    </form>
                </div>
            </div>
        </div>
