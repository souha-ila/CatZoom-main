<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="com.example.demo.entity.Demande" %>
  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <div class="content">
        ...
        <div class="card-header">
            <h5 class="card-category">requests List</h5>
        </div>
        <div class="card-body">
            ...
            for (Demande demande : requests) { %>
                <tr>
                    <th scope="row"><%= demande.getId() %></th>
                    <td><%= demande.getUtilisateur().getEmail() %></td>
                    <td><%= demande.getChat().getNom() %></td>
                    
                   
                    <td>
                        <img src="<%= request.getContextPath() %>/resources/images/<%= demande.getChat().getImage() %>"
                            alt="Cat Image" width="50" height="50">
                    </td>
                    <td>
                        
                        <a href="deletereq/<%= demande.getId() %>" onclick="return confirmDelete();">
